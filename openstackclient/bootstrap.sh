...
PROJECT=$3
ROLE=$4
KEYSTONE_ADMIN_URL=http://identity:35357/v3
KEYSTONE_INTERNAL_URL=http://identity:5000/v3
KEYSTONE_PUBLIC_URL=http://identity:5000/v3
GLANCE_ADMIN_URL=http://image:9292
GLANCE_INTERNAL_URL=http://image:9292
GLANCE_PUBLIC_URL=http://image:9292
NOVA_ADMIN_URL=http://controller:8774/v2.1/%\(tenant_id\)s
NOVA_INTERNAL_URL=http://controller:8774/v2.1/%\(tenant_id\)s
NOVA_PUBLIC_URL=http://controller:8774/v2.1/%\(tenant_id\)s
